...
The idea is to get the best pair according to MAE.
This is not entirely correct, as it effectively 'trains' on the test data (the entire database).
It is used only for comparison purposes.
""" 

# Calculate static values with the best MAE on database 
# Best pair: [10.0, 25.0] with L1 / MAE loss: 100.3961
