...
Website:[text](https://prostor.zgs.gov.si/pregledovalnik/)
...
Podatke mormo pretvorit v smiselno relacijsko bazo:
![Primer sheme](docs/shema_v2.png)
To ni končna verzija, definitivno je treba jo dodelat...
